<!-- GENERATED from music/engineering-wiki/: workflows/testing.md, theory-engine/theory-verification.md | regenerated by re-synthesizing those pages | 2026-09-06 -->
...
| `wiki-lifecycle-drift.test.js` | retired markers, source/generated agreement, inventory counts, and evidence-summary reconciliation |
...
The ground-truth encoder uses letter-sequential spelling. The core assertions compare
pitch class, quality, and degree rather than display letters; active display spelling
is guarded separately by `key-spelling.test.js`.
...
An adversarial model review using a GPT-5.5 senior-professor prompt found no bugs within
the tested pitch-class, degree-order, triad-quality, and roman-case canon. It produced
useful trap cases but is not independent human-expert validation. Full detail lives in
[THEORY.md](THEORY.md).
