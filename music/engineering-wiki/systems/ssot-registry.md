...
| Toast feedback | [toast.js](../../shared/toast.js) (SHIPPED PR #145 - one timer per host) | songbook library + compose toasts (thin delegates) | Never a local toast timer/element; the shadowed-timer bug class (U9) is why |
