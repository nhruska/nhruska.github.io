...
(function (global) {
  ...
  function mount(opts) {
    ...
    // last-used mode is restored on open; Stage falls back to the Studio screen
    // underneath and launches the fullscreen perform overlay on top.
    ...
    function openPractice(id) { // opens the song screen in the last-used mode
