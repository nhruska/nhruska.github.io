...
(function (g) {
  ...
  g.MusicProfiles["guitar-standard"] = {
    ...
    chords: {
      ...
      // 3-fret-symmetric so 4 roots share each shape: F1=[x,3,4,2,4,2] (C/Eb/F#/A),
      // F2=[x,4,5,3,5,3] (C#/E/G/Bb), F3=[x,5,6,4,6,4] (D/F/G#/B).
      Cdim: [-1, 3, 4, 2, 4, 2], "D#dim": [-1, 3, 4, 2, 4, 2], Ebdim: [-1, 3, 4, 2, 4, 2], "F#dim": [-1, 3, 4, 2, 4, 2], Gbdim: [-1, 3, 4, 2, 4, 2], Adim: [-1, 3, 4, 2, 4, 2],
      "C#dim": [-1, 4, 5, 3, 5, 3], Dbdim: [-1, 4, 5, 3, 5, 3], Edim: [-1, 4, 5, 3, 5, 3], Gdim: [-1, 4, 5, 3, 5, 3], "A#dim": [-1, 4, 5, 3, 5, 3], Bbdim: [-1, 4, 5, 3, 5, 3],
      Ddim: [-1, 5, 6, 4, 6, 4], Fdim: [-1, 5, 6, 4, 6, 4], "G#dim": [-1, 5, 6, 4, 6, 4], Abdim: [-1, 5, 6, 4, 6, 4], Bdim: [-1, 5, 6, 4, 6, 4]
    }
  };
