...
(function (global) {
  ...
  function mount(opts) {
    ...
    // M4: an optional VISIBLE home for the curate bar (the in-container bar lives
    // inside the retired, permanently-hidden finder tab - unreachable). When the
    // host supplies a slot, the bar renders there and the queue opens as a
    // body-level panel (same pattern as the player/Studio overlay).
